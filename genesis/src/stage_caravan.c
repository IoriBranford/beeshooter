...
{.x = -32, .y = 3864, .action = spawnCharacters, .group = &room1ants3},
{.x = -32, .y = 3856, .action = spawnCharacters, .group = &room1ants3},
{.x = -32, .y = 3848, .action = spawnCharacters, .group = &room1ants3},
...
{.x = -32, .y = 3792, .action = spawnCharacters, .group = &room1ants4},
{.x = -32, .y = 3784, .action = spawnCharacters, .group = &room1ants4},
{.x = -32, .y = 3776, .action = spawnCharacters, .group = &room1ants4},
{.x = -20, .y = 3768, .action = spawnCharacters, .group = &room1powerup},
