...
extern const LevelObject lobj2883;
extern const LevelObject lobj2886;
extern const LevelObject lobj2884;
extern const LevelObject lobj2887;
extern const LevelObject lobj2885;
...
/*  67 */ { .group = &r6ants, .action = spawnNextCharacters, .count = 2, .x = -8, .y = 2872 },
/*  68 */ { .group = &r6ants, .action = spawnNextCharacters, .count = 2, .x = -8, .y = 2864 },
/*  69 */ { .group = &r6ants, .action = spawnNextCharacters, .count = 2, .x = -8, .y = 2856 },
/*  70 */ { .group = &r6ants, .action = spawnNextCharacters, .count = 2, .x = -8, .y = 2848 },
/*  71 */ { .group = &r6ants, .action = spawnNextCharacters, .count = 2, .x = -8, .y = 2840 },
/*  72 */ { .group = &r6ants, .action = spawnNextCharacters, .count = 2, .x = -8, .y = 2832 },
/*  73 */ { .group = &r6ants, .action = spawnNextCharacters, .count = 2, .x = -8, .y = 2824 },
/*  74 */ { .group = &r6ants, .action = spawnNextCharacters, .count = 2, .x = -8, .y = 2816 },
/*  75 */ { .group = &room6fly, .action = spawnCharacters, .count = 0, .x = -24, .y = 2816 },
/*  76 */ { .group = &r6ants, .action = spawnNextCharacters, .count = 2, .x = -8, .y = 2808 },
/*  77 */ { .group = &r6ants, .action = spawnNextCharacters, .count = 2, .x = -8, .y = 2800 },
/*  78 */ { .group = &r6ants, .action = spawnNextCharacters, .count = 2, .x = -8, .y = 2792 },
/*  79 */ { .group = &room6antsfrombigants, .action = spawnCharacters, .count = 0, .x = -8, .y = 2784 },
/*  80 */ { .group = &room6antsfrombigants, .action = spawnCharacters, .count = 0, .x = -8, .y = 2772 },
/*  81 */ { .group = &room6antsfrombigants, .action = spawnCharacters, .count = 0, .x = -8, .y = 2760 },
/*  82 */ { .group = &room6antsfrombigants, .action = spawnCharacters, .count = 0, .x = -8, .y = 2748 },
/*  83 */ { .group = &room6bigant, .action = spawnCharacters, .count = 0, .x = -8, .y = 2736 },
/*  84 */ { .group = &room7alien1, .action = spawnCharacters, .count = 0, .x = -56, .y = 2504 },
/*  85 */ { .group = &room7alien2, .action = spawnCharacters, .count = 0, .x = -80, .y = 2448 },
/*  86 */ { .group = &room7alien3, .action = spawnCharacters, .count = 0, .x = -56, .y = 2432 },
/*  87 */ { .group = &room8alien1, .action = spawnNextCharacters, .count = 1, .x = 0, .y = 2376 },
/*  88 */ { .group = &room8alien1, .action = spawnNextCharacters, .count = 1, .x = 28, .y = 2368 },
/*  89 */ { .group = &room8alien1, .action = spawnNextCharacters, .count = 1, .x = -8, .y = 2360 },
/*  90 */ { .group = &room8alien2, .action = spawnCharacters, .count = 0, .x = -56, .y = 2360 },
/*  91 */ { .group = &room8alien1, .action = spawnNextCharacters, .count = 1, .x = 32, .y = 2352 },
/*  92 */ { .group = &room8alien1, .action = spawnNextCharacters, .count = 2, .x = 12, .y = 2344 },
/*  93 */ { .group = &room8alien1, .action = spawnNextCharacters, .count = 3, .x = 12, .y = 2328 },
/*  94 */ { .group = &room8alien1, .action = spawnNextCharacters, .count = 1, .x = 16, .y = 2320 },
/*  95 */ { .group = &room8alien1, .action = spawnNextCharacters, .count = 2, .x = 8, .y = 2312 },
/*  96 */ { .group = &room8powerup, .action = spawnCharacters, .count = 0, .x = -32, .y = 2272 },
...
/* 157 */ { .group = &r13acidantholes, .action = spawnCharacters, .count = 0, .x = -96, .y = 1328 },
...
/* 163 */ { .group = &r14beetles, .action = spawnCharacters, .count = 0, .x = -24, .y = 1072 },
/* 164 */ { .group = &r14wasp2b, .action = spawnCharacters, .count = 0, .x = -56, .y = 1032 },
/* 165 */ { .group = &r14powerup1, .action = spawnCharacters, .count = 0, .x = -136, .y = 1000 },
/* 166 */ { .group = &r14wasp3a, .action = spawnCharacters, .count = 0, .x = -88, .y = 976 },
/* 167 */ { .group = &r14powerup2, .action = spawnCharacters, .count = 0, .x = -48, .y = 968 },
/* 168 */ { .group = &r15powerup1, .action = spawnCharacters, .count = 0, .x = -48, .y = 872 },
/* 169 */ { .group = &r14wasp4a, .action = spawnCharacters, .count = 0, .x = -88, .y = 872 },
/* 170 */ { .group = &r14wasp5a, .action = spawnCharacters, .count = 0, .x = -88, .y = 808 },
/* 171 */ { .group = &r15powerup2, .action = spawnCharacters, .count = 0, .x = -136, .y = 808 },
/* 172 */ { .group = &r14wasp6a, .action = spawnCharacters, .count = 0, .x = -120, .y = 760 },
/* 173 */ { .group = &Copy_of_r14wasp6a, .action = spawnCharacters, .count = 0, .x = -8, .y = 728 },
/* 174 */ { .group = &r16acidants1, .action = spawnCharacters, .count = 0, .x = -72, .y = 656 },
/* 175 */ { .group = &r16acidants1, .action = spawnCharacters, .count = 0, .x = -72, .y = 640 },
/* 176 */ { .group = &r16acidants1, .action = spawnCharacters, .count = 0, .x = -72, .y = 624 },
/* 177 */ { .group = &r16powerup, .action = spawnCharacters, .count = 0, .x = -32, .y = 608 },
/* 178 */ { .group = &r16acidants1, .action = spawnCharacters, .count = 0, .x = -72, .y = 608 },
/* 179 */ { .group = &r16acidants2, .action = spawnCharacters, .count = 0, .x = -56, .y = 592 },
/* 180 */ { .group = &r16acidants1, .action = spawnCharacters, .count = 0, .x = -72, .y = 592 },
/* 181 */ { .group = &r16acidants2, .action = spawnCharacters, .count = 0, .x = -56, .y = 576 },
/* 182 */ { .group = &r16acidants1, .action = spawnCharacters, .count = 0, .x = -72, .y = 576 },
/* 183 */ { .group = &r16acidants2, .action = spawnCharacters, .count = 0, .x = -56, .y = 560 },
/* 184 */ { .group = &r16acidants1, .action = spawnCharacters, .count = 0, .x = -72, .y = 560 },
/* 185 */ { .group = &r16acidants2, .action = spawnCharacters, .count = 0, .x = -56, .y = 544 },
/* 186 */ { .group = &r16acidants1, .action = spawnCharacters, .count = 0, .x = -72, .y = 544 },
/* 187 */ { .group = &r16acidants2, .action = spawnCharacters, .count = 0, .x = -56, .y = 528 },
/* 188 */ { .group = &r16acidants1, .action = spawnCharacters, .count = 0, .x = -72, .y = 528 },
/* 189 */ { .group = &r16powerup2, .action = spawnCharacters, .count = 0, .x = -16, .y = 520 },
/* 190 */ { .group = &r16acidants2, .action = spawnCharacters, .count = 0, .x = -56, .y = 512 },
/* 191 */ { .group = &r16acidants1, .action = spawnCharacters, .count = 0, .x = -72, .y = 512 },
/* 192 */ { .group = &r16acidants2, .action = spawnCharacters, .count = 0, .x = -56, .y = 496 },
/* 193 */ { .group = &r16acidants1, .action = spawnCharacters, .count = 0, .x = -72, .y = 496 },
/* 194 */ { .group = &r16acidants2, .action = spawnCharacters, .count = 0, .x = -56, .y = 480 },
/* 195 */ { .group = &r16acidants1, .action = spawnCharacters, .count = 0, .x = -72, .y = 480 },
/* 196 */ { .group = &r16acidants2, .action = spawnCharacters, .count = 0, .x = -56, .y = 464 },
/* 197 */ { .group = &r16acidants2, .action = spawnCharacters, .count = 0, .x = -56, .y = 448 },
/* 198 */ { .group = &r16acidants2, .action = spawnCharacters, .count = 0, .x = -56, .y = 432 },
/* 199 */ { .group = &r17powerup, .action = spawnCharacters, .count = 0, .x = -40, .y = 424 },
/* 200 */ { .group = &r16acidants2, .action = spawnCharacters, .count = 0, .x = -56, .y = 416 },
/* 201 */ { .group = &r17fly1b, .action = spawnCharacters, .count = 0, .x = -104, .y = 408 },
/* 202 */ { .group = &r17fly1a, .action = spawnCharacters, .count = 0, .x = -184, .y = 408 },
/* 203 */ { .group = &r17fly2b, .action = spawnCharacters, .count = 0, .x = -120, .y = 384 },
/* 204 */ { .group = &r17fly2a, .action = spawnCharacters, .count = 0, .x = -200, .y = 384 },
/* 205 */ { .group = &r17wasp1, .action = spawnCharacters, .count = 0, .x = -104, .y = 344 },
/* 206 */ { .group = &r17wasp3, .action = spawnCharacters, .count = 0, .x = -104, .y = 328 },
/* 207 */ { .group = &r17wasp5, .action = spawnCharacters, .count = 0, .x = -104, .y = 312 },
