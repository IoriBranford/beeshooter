...
extern LevelObjectGroup bonusLetters;
extern const LevelObject lobj4382;
extern const LevelObject lobj4384;
extern const LevelObject lobj4386;
extern const LevelObject lobj4388;
extern const LevelObject lobj4390;
const LevelObject lobj4382 = {
...
static const LevelObject *bonusLetters_objects[] = {
    &lobj4382,
    &lobj4384,
    &lobj4386,
    &lobj4388,
...
LevelObjectGroup bonusLetters = {
    .numPaths = 0, .paths = 0,
    .numObjects = 5, .objects = bonusLetters_objects
};
...
const Path path3179 = {
.x = -80, .y = 128, .numPoints = 5, .points = {
{
    .x = 208, .y = 120,
    .speedTo = 320, .distTo = 0,
    .xVelTo = 0, .yVelTo = 0,
    .numActions = 0,
    .actions = 0
},
{
    .x = 192, .y = 136,
    .speedTo = 320, .distTo = 1448,
    .xVelTo = -227, .yVelTo = 226,
    .numActions = 0,
    .actions = 0
},
{
    .x = 160, .y = 152,
    .speedTo = 320, .distTo = 2289,
    .xVelTo = -287, .yVelTo = 143,
    .numActions = 0,
    .actions = 0
},
{
    .x = 128, .y = 136,
    .speedTo = 320, .distTo = 2289,
    .xVelTo = -287, .yVelTo = -144,
    .numActions = 0,
    .actions = 0
},
{
    .x = 112, .y = 112,
    .speedTo = 320, .distTo = 1846,
    .xVelTo = -178, .yVelTo = -267,
    .numActions = 1,
...
{.action = PathPoint_ShootBurstsAtAngle, .count = 12, .interval = 3, .angle = 128}
};
static const GameObjectAction path3181_2_actions[] = {
{.action = ChargeAndLayEggs, }
};
const Path path3181 = {
.x = 32, .y = 240, .numPoints = 3, .points = {
{
    .x = 0, .y = 8,
    .speedTo = 320, .distTo = 0,
    .xVelTo = 0, .yVelTo = 0,
...
{.action = PathPoint_ShootBurstsAtAngle, .count = 12, .interval = 3, .angle = 384}
};
static const GameObjectAction path3182_2_actions[] = {
{.action = ChargeAndLayEggs, }
};
const Path path3182 = {
.x = 224, .y = 240, .numPoints = 3, .points = {
{
    .x = 0, .y = 8,
    .speedTo = 320, .distTo = 0,
    .xVelTo = 0, .yVelTo = 0,
...
{
    .x = 88, .y = 8,
    .speedTo = 320, .distTo = 7964,
    .xVelTo = 226, .yVelTo = -227,
    .numActions = 1,
...
/*   1 */ { .group = &room1ants1, .action = spawnCharacters, .count = 0, .x = -32, .y = 3976 },
...
/*  10 */ { .group = &bonusLetters, .action = spawnNextCharacters, .count = 1, .x = -60, .y = 3848 },
/*  11 */ { .group = &room1ants3, .action = spawnCharacters, .count = 0, .x = -44, .y = 3848 },
/*  12 */ { .group = &room1ants3, .action = spawnCharacters, .count = 0, .x = -44, .y = 3840 },
/*  13 */ { .group = &room1ants3, .action = spawnCharacters, .count = 0, .x = -44, .y = 3832 },
/*  14 */ { .group = &room1ants4, .action = spawnCharacters, .count = 0, .x = -32, .y = 3832 },
/*  15 */ { .group = &room1ants4, .action = spawnCharacters, .count = 0, .x = -32, .y = 3824 },
/*  16 */ { .group = &room1ants4, .action = spawnCharacters, .count = 0, .x = -32, .y = 3816 },
/*  17 */ { .group = &room1ants4, .action = spawnCharacters, .count = 0, .x = -32, .y = 3808 },
/*  18 */ { .group = &room1ants4, .action = spawnCharacters, .count = 0, .x = -32, .y = 3800 },
/*  19 */ { .group = &room1ants4, .action = spawnCharacters, .count = 0, .x = -32, .y = 3792 },
/*  20 */ { .group = &room1ants4, .action = spawnCharacters, .count = 0, .x = -32, .y = 3784 },
/*  21 */ { .group = &room1ants4, .action = spawnCharacters, .count = 0, .x = -32, .y = 3776 },
/*  22 */ { .group = &room1ants4, .action = spawnCharacters, .count = 0, .x = -32, .y = 3768 },
/*  23 */ { .group = &room1powerup, .action = spawnCharacters, .count = 0, .x = -20, .y = 3768 },
/*  24 */ { .group = &room1ants4, .action = spawnCharacters, .count = 0, .x = -32, .y = 3760 },
/*  25 */ { .group = &room2ants1, .action = spawnCharacters, .count = 0, .x = -56, .y = 3680 },
/*  26 */ { .group = &room2ants2, .action = spawnCharacters, .count = 0, .x = -56, .y = 3616 },
/*  27 */ { .group = &room2powerup, .action = spawnCharacters, .count = 0, .x = -80, .y = 3576 },
/*  28 */ { .group = &r3fly1, .action = spawnCharacters, .count = 0, .x = -56, .y = 3544 },
/*  29 */ { .group = &room3fly3, .action = spawnCharacters, .count = 0, .x = -56, .y = 3448 },
/*  30 */ { .group = &room3fly4, .action = spawnCharacters, .count = 0, .x = -56, .y = 3352 },
/*  31 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -40, .y = 3244 },
/*  32 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -44, .y = 3236 },
/*  33 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -40, .y = 3228 },
/*  34 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -36, .y = 3220 },
/*  35 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -32, .y = 3212 },
/*  36 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -28, .y = 3204 },
/*  37 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -24, .y = 3196 },
/*  38 */ { .group = &room4powerup, .action = spawnCharacters, .count = 0, .x = -56, .y = 3192 },
/*  39 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -20, .y = 3188 },
/*  40 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -24, .y = 3180 },
/*  41 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -28, .y = 3172 },
/*  42 */ { .group = &r4fly1, .action = spawnCharacters, .count = 0, .x = -56, .y = 3168 },
/*  43 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -32, .y = 3164 },
/*  44 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -36, .y = 3156 },
/*  45 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -40, .y = 3148 },
/*  46 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -44, .y = 3140 },
/*  47 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -40, .y = 3132 },
/*  48 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -36, .y = 3124 },
/*  49 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -32, .y = 3116 },
/*  50 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -28, .y = 3108 },
/*  51 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -24, .y = 3100 },
/*  52 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -20, .y = 3092 },
/*  53 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -24, .y = 3084 },
/*  54 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -28, .y = 3076 },
/*  55 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -32, .y = 3068 },
/*  56 */ { .group = &r5powerup, .action = spawnCharacters, .count = 0, .x = -72, .y = 3064 },
/*  57 */ { .group = &room5fly1, .action = spawnCharacters, .count = 0, .x = -56, .y = 3064 },
/*  58 */ { .group = &bonusLetters, .action = spawnNextCharacters, .count = 1, .x = -4, .y = 3064 },
/*  59 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -36, .y = 3060 },
/*  60 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -40, .y = 3052 },
/*  61 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -44, .y = 3044 },
/*  62 */ { .group = &r4r5ants, .action = spawnNextCharacters, .count = 2, .x = -40, .y = 3036 },
/*  63 */ { .group = &r5antsfrombigant, .action = spawnCharacters, .count = 0, .x = -36, .y = 3028 },
/*  64 */ { .group = &r5antsfrombigant, .action = spawnCharacters, .count = 0, .x = -36, .y = 3012 },
/*  65 */ { .group = &r5antsfrombigant, .action = spawnCharacters, .count = 0, .x = -36, .y = 2996 },
/*  66 */ { .group = &r5antsfrombigant, .action = spawnCharacters, .count = 0, .x = -36, .y = 2980 },
/*  67 */ { .group = &r5antsfrombigant, .action = spawnCharacters, .count = 0, .x = -36, .y = 2964 },
/*  68 */ { .group = &room5bigant, .action = spawnCharacters, .count = 0, .x = -36, .y = 2948 },
/*  69 */ { .group = &room5bigant, .action = postDoubleKillBonus, .count = 10000, .x = -28, .y = 2948 },
/*  70 */ { .group = &r6ants, .action = spawnNextCharacters, .count = 2, .x = -8, .y = 2872 },
/*  71 */ { .group = &r6ants, .action = spawnNextCharacters, .count = 2, .x = -8, .y = 2864 },
/*  72 */ { .group = &r6ants, .action = spawnNextCharacters, .count = 2, .x = -8, .y = 2856 },
/*  73 */ { .group = &r6ants, .action = spawnNextCharacters, .count = 2, .x = -8, .y = 2848 },
/*  74 */ { .group = &r6ants, .action = spawnNextCharacters, .count = 2, .x = -8, .y = 2840 },
/*  75 */ { .group = &r6ants, .action = spawnNextCharacters, .count = 2, .x = -8, .y = 2832 },
/*  76 */ { .group = &r6ants, .action = spawnNextCharacters, .count = 2, .x = -8, .y = 2824 },
/*  77 */ { .group = &room6fly, .action = spawnCharacters, .count = 0, .x = -24, .y = 2816 },
/*  78 */ { .group = &r6ants, .action = spawnNextCharacters, .count = 2, .x = -8, .y = 2816 },
/*  79 */ { .group = &r6ants, .action = spawnNextCharacters, .count = 2, .x = -8, .y = 2808 },
/*  80 */ { .group = &r6ants, .action = spawnNextCharacters, .count = 2, .x = -8, .y = 2800 },
/*  81 */ { .group = &r6ants, .action = spawnNextCharacters, .count = 2, .x = -8, .y = 2792 },
/*  82 */ { .group = &room6antsfrombigants, .action = spawnCharacters, .count = 0, .x = -8, .y = 2784 },
/*  83 */ { .group = &room6antsfrombigants, .action = spawnCharacters, .count = 0, .x = -8, .y = 2772 },
/*  84 */ { .group = &room6antsfrombigants, .action = spawnCharacters, .count = 0, .x = -8, .y = 2760 },
/*  85 */ { .group = &room6antsfrombigants, .action = spawnCharacters, .count = 0, .x = -8, .y = 2748 },
/*  86 */ { .group = &room6bigant, .action = spawnCharacters, .count = 0, .x = -8, .y = 2736 },
/*  87 */ { .group = &room6bigant, .action = postDoubleKillBonus, .count = 10000, .x = 0, .y = 2736 },
/*  88 */ { .group = &room7alien1, .action = spawnCharacters, .count = 0, .x = -56, .y = 2504 },
/*  89 */ { .group = &room7alien2, .action = spawnCharacters, .count = 0, .x = -80, .y = 2448 },
/*  90 */ { .group = &bonusLetters, .action = spawnNextCharacters, .count = 1, .x = -28, .y = 2440 },
/*  91 */ { .group = &room7alien3, .action = spawnCharacters, .count = 0, .x = -56, .y = 2432 },
/*  92 */ { .group = &room8alien1, .action = spawnNextCharacters, .count = 1, .x = 0, .y = 2376 },
/*  93 */ { .group = &room8alien1, .action = spawnNextCharacters, .count = 1, .x = 28, .y = 2368 },
/*  94 */ { .group = &room8alien2, .action = spawnCharacters, .count = 0, .x = -56, .y = 2360 },
/*  95 */ { .group = &room8alien1, .action = spawnNextCharacters, .count = 1, .x = -8, .y = 2360 },
/*  96 */ { .group = &room8alien1, .action = spawnNextCharacters, .count = 1, .x = 32, .y = 2352 },
/*  97 */ { .group = &room8alien1, .action = spawnNextCharacters, .count = 2, .x = 12, .y = 2344 },
/*  98 */ { .group = &room8alien1, .action = spawnNextCharacters, .count = 3, .x = 12, .y = 2328 },
/*  99 */ { .group = &room8alien1, .action = spawnNextCharacters, .count = 1, .x = 16, .y = 2320 },
/* 100 */ { .group = &room8alien1, .action = spawnNextCharacters, .count = 2, .x = 8, .y = 2312 },
/* 101 */ { .group = &room8powerup, .action = spawnCharacters, .count = 0, .x = -32, .y = 2272 },
/* 102 */ { .group = &room8alien4, .action = spawnCharacters, .count = 0, .x = -72, .y = 2264 },
/* 103 */ { .group = &room9powerup, .action = spawnCharacters, .count = 0, .x = -16, .y = 2184 },
/* 104 */ { .group = &room9alienmind, .action = stopStageScroll, .count = 0, .x = -32, .y = 2016 },
/* 105 */ { .group = &room9alienmind, .action = spawnCharacters, .count = 0, .x = -16, .y = 2016 },
/* 106 */ { .group = &part2, .action = loadPart2, .count = 0, .x = -24, .y = 2008 },
/* 107 */ { .group = &room10acidants, .action = unpauseTimer, .count = 0, .x = -40, .y = 1856 },
/* 108 */ { .group = &room10acidants, .action = spawnCharacters, .count = 0, .x = -32, .y = 1856 },
/* 109 */ { .group = &room10acidants2, .action = spawnCharacters, .count = 0, .x = -32, .y = 1840 },
/* 110 */ { .group = &r11acidants1a, .action = spawnCharacters, .count = 0, .x = -48, .y = 1760 },
/* 111 */ { .group = &r11acidants1b, .action = spawnCharacters, .count = 0, .x = -56, .y = 1752 },
/* 112 */ { .group = &r11acidants1c, .action = spawnCharacters, .count = 0, .x = -48, .y = 1744 },
/* 113 */ { .group = &r11acidants1d, .action = spawnCharacters, .count = 0, .x = -56, .y = 1736 },
/* 114 */ { .group = &r11acidants1e, .action = spawnCharacters, .count = 0, .x = -48, .y = 1728 },
/* 115 */ { .group = &r11acidants1f, .action = spawnCharacters, .count = 0, .x = -56, .y = 1720 },
/* 116 */ { .group = &r11acidants1g, .action = spawnCharacters, .count = 0, .x = -48, .y = 1712 },
/* 117 */ { .group = &r11acidants1h, .action = spawnCharacters, .count = 0, .x = -56, .y = 1704 },
/* 118 */ { .group = &r11powerup, .action = spawnCharacters, .count = 0, .x = -96, .y = 1664 },
/* 119 */ { .group = &bonusLetters, .action = spawnNextCharacters, .count = 1, .x = -144, .y = 1656 },
/* 120 */ { .group = &r11acidants3a, .action = spawnCharacters, .count = 0, .x = -48, .y = 1632 },
/* 121 */ { .group = &room11acidants2a, .action = spawnCharacters, .count = 0, .x = -32, .y = 1632 },
/* 122 */ { .group = &r11acidants3b, .action = spawnCharacters, .count = 0, .x = -56, .y = 1624 },
/* 123 */ { .group = &room11acidants2a, .action = spawnCharacters, .count = 0, .x = -32, .y = 1624 },
/* 124 */ { .group = &r11acidants3c, .action = spawnCharacters, .count = 0, .x = -48, .y = 1616 },
/* 125 */ { .group = &room11acidants2a, .action = spawnCharacters, .count = 0, .x = -32, .y = 1616 },
/* 126 */ { .group = &r11acidants3d, .action = spawnCharacters, .count = 0, .x = -56, .y = 1608 },
/* 127 */ { .group = &room11acidants2a, .action = spawnCharacters, .count = 0, .x = -32, .y = 1608 },
/* 128 */ { .group = &r11acidants3e, .action = spawnCharacters, .count = 0, .x = -48, .y = 1600 },
/* 129 */ { .group = &room11acidants2a, .action = spawnCharacters, .count = 0, .x = -32, .y = 1600 },
/* 130 */ { .group = &r11acidants3f, .action = spawnCharacters, .count = 0, .x = -56, .y = 1592 },
/* 131 */ { .group = &room11acidants2a, .action = spawnCharacters, .count = 0, .x = -32, .y = 1592 },
/* 132 */ { .group = &room11acidants2b, .action = spawnCharacters, .count = 0, .x = -88, .y = 1584 },
/* 133 */ { .group = &r11acidants3g, .action = spawnCharacters, .count = 0, .x = -48, .y = 1584 },
/* 134 */ { .group = &room11acidants2a, .action = spawnCharacters, .count = 0, .x = -32, .y = 1584 },
/* 135 */ { .group = &room11acidants2b, .action = spawnCharacters, .count = 0, .x = -88, .y = 1576 },
/* 136 */ { .group = &r11acidants3h, .action = spawnCharacters, .count = 0, .x = -56, .y = 1576 },
/* 137 */ { .group = &room11acidants2a, .action = spawnCharacters, .count = 0, .x = -32, .y = 1576 },
/* 138 */ { .group = &room11acidants2b, .action = spawnCharacters, .count = 0, .x = -88, .y = 1568 },
/* 139 */ { .group = &r11acidants3i, .action = spawnCharacters, .count = 0, .x = -48, .y = 1568 },
/* 140 */ { .group = &room11acidants2a, .action = spawnCharacters, .count = 0, .x = -32, .y = 1568 },
/* 141 */ { .group = &room11acidants2b, .action = spawnCharacters, .count = 0, .x = -88, .y = 1560 },
/* 142 */ { .group = &r11acidants3j, .action = spawnCharacters, .count = 0, .x = -56, .y = 1560 },
/* 143 */ { .group = &room11acidants2a, .action = spawnCharacters, .count = 0, .x = -32, .y = 1560 },
/* 144 */ { .group = &room11acidants2b, .action = spawnCharacters, .count = 0, .x = -88, .y = 1552 },
/* 145 */ { .group = &r11acidants3k, .action = spawnCharacters, .count = 0, .x = -48, .y = 1552 },
/* 146 */ { .group = &room11acidants2b, .action = spawnCharacters, .count = 0, .x = -88, .y = 1544 },
/* 147 */ { .group = &room11acidants2b, .action = spawnCharacters, .count = 0, .x = -88, .y = 1536 },
/* 148 */ { .group = &room11acidants2b, .action = spawnCharacters, .count = 0, .x = -88, .y = 1528 },
/* 149 */ { .group = &room11acidants2b, .action = spawnCharacters, .count = 0, .x = -88, .y = 1520 },
/* 150 */ { .group = &room11acidants2b, .action = spawnCharacters, .count = 0, .x = -88, .y = 1512 },
/* 151 */ { .group = &r12wasp1c, .action = spawnCharacters, .count = 0, .x = -40, .y = 1488 },
/* 152 */ { .group = &r12wasp1b, .action = spawnCharacters, .count = 0, .x = -48, .y = 1472 },
/* 153 */ { .group = &r12wasp1a, .action = spawnCharacters, .count = 0, .x = -56, .y = 1456 },
/* 154 */ { .group = &r12wasp3a, .action = spawnCharacters, .count = 0, .x = -40, .y = 1416 },
/* 155 */ { .group = &r12wasp3b, .action = spawnCharacters, .count = 0, .x = -32, .y = 1408 },
/* 156 */ { .group = &r12wasp3c, .action = spawnCharacters, .count = 0, .x = -24, .y = 1400 },
/* 157 */ { .group = &r12wasp2a, .action = spawnCharacters, .count = 0, .x = -56, .y = 1392 },
/* 158 */ { .group = &r12wasp2b, .action = spawnCharacters, .count = 0, .x = -64, .y = 1384 },
/* 159 */ { .group = &r12wasp2c, .action = spawnCharacters, .count = 0, .x = -72, .y = 1376 },
/* 160 */ { .group = &r12powerup, .action = spawnCharacters, .count = 0, .x = -40, .y = 1368 },
/* 161 */ { .group = &r12wasp4a, .action = spawnCharacters, .count = 0, .x = -80, .y = 1336 },
/* 162 */ { .group = &r12wasp4b, .action = spawnCharacters, .count = 0, .x = -16, .y = 1336 },
/* 163 */ { .group = &r13acidantholes, .action = spawnCharacters, .count = 0, .x = -96, .y = 1328 },
/* 164 */ { .group = &r12wasp4c, .action = spawnCharacters, .count = 0, .x = -64, .y = 1312 },
/* 165 */ { .group = &r12wasp4d, .action = spawnCharacters, .count = 0, .x = -32, .y = 1312 },
/* 166 */ { .group = &r13beetle1, .action = spawnCharacters, .count = 0, .x = -48, .y = 1288 },
/* 167 */ { .group = &r13beetle1, .action = postDoubleKillBonus, .count = 25000, .x = -40, .y = 1288 },
/* 168 */ { .group = &r13fly1, .action = spawnCharacters, .count = 0, .x = -64, .y = 1192 },
/* 169 */ { .group = &r13fly3, .action = spawnCharacters, .count = 0, .x = -48, .y = 1152 },
/* 170 */ { .group = &r14beetles, .action = spawnCharacters, .count = 0, .x = -24, .y = 1072 },
/* 171 */ { .group = &r14beetles, .action = postDoubleKillBonus, .count = 50000, .x = -12, .y = 1072 },
/* 172 */ { .group = &r14wasp2b, .action = spawnCharacters, .count = 0, .x = -56, .y = 1032 },
/* 173 */ { .group = &r14powerup1, .action = spawnCharacters, .count = 0, .x = -136, .y = 1000 },
...
/* 176 */ { .group = &r14wasp4a, .action = spawnCharacters, .count = 0, .x = -88, .y = 872 },
/* 177 */ { .group = &r15powerup1, .action = spawnCharacters, .count = 0, .x = -48, .y = 872 },
/* 178 */ { .group = &r15powerup2, .action = spawnCharacters, .count = 0, .x = -136, .y = 808 },
/* 179 */ { .group = &r14wasp5a, .action = spawnCharacters, .count = 0, .x = -88, .y = 808 },
/* 180 */ { .group = &bonusLetters, .action = spawnNextCharacters, .count = 1, .x = -48, .y = 808 },
/* 181 */ { .group = &r14wasp6a, .action = spawnCharacters, .count = 0, .x = -120, .y = 760 },
/* 182 */ { .group = &Copy_of_r14wasp6a, .action = spawnCharacters, .count = 0, .x = -8, .y = 728 },
/* 183 */ { .group = &r16acidants1, .action = spawnCharacters, .count = 0, .x = -72, .y = 656 },
/* 184 */ { .group = &r16acidants1, .action = spawnCharacters, .count = 0, .x = -72, .y = 640 },
/* 185 */ { .group = &r16acidants1, .action = spawnCharacters, .count = 0, .x = -72, .y = 624 },
/* 186 */ { .group = &r16acidants1, .action = spawnCharacters, .count = 0, .x = -72, .y = 608 },
/* 187 */ { .group = &r16powerup, .action = spawnCharacters, .count = 0, .x = -32, .y = 608 },
/* 188 */ { .group = &r16acidants1, .action = spawnCharacters, .count = 0, .x = -72, .y = 592 },
/* 189 */ { .group = &r16acidants2, .action = spawnCharacters, .count = 0, .x = -56, .y = 592 },
/* 190 */ { .group = &r16acidants1, .action = spawnCharacters, .count = 0, .x = -72, .y = 576 },
/* 191 */ { .group = &r16acidants2, .action = spawnCharacters, .count = 0, .x = -56, .y = 576 },
/* 192 */ { .group = &r16acidants1, .action = spawnCharacters, .count = 0, .x = -72, .y = 560 },
/* 193 */ { .group = &r16acidants2, .action = spawnCharacters, .count = 0, .x = -56, .y = 560 },
/* 194 */ { .group = &r16acidants1, .action = spawnCharacters, .count = 0, .x = -72, .y = 544 },
/* 195 */ { .group = &r16acidants2, .action = spawnCharacters, .count = 0, .x = -56, .y = 544 },
/* 196 */ { .group = &r16acidants1, .action = spawnCharacters, .count = 0, .x = -72, .y = 528 },
/* 197 */ { .group = &r16acidants2, .action = spawnCharacters, .count = 0, .x = -56, .y = 528 },
/* 198 */ { .group = &r16powerup2, .action = spawnCharacters, .count = 0, .x = -16, .y = 520 },
/* 199 */ { .group = &r16acidants1, .action = spawnCharacters, .count = 0, .x = -72, .y = 512 },
/* 200 */ { .group = &r16acidants2, .action = spawnCharacters, .count = 0, .x = -56, .y = 512 },
/* 201 */ { .group = &r16acidants1, .action = spawnCharacters, .count = 0, .x = -72, .y = 496 },
/* 202 */ { .group = &r16acidants2, .action = spawnCharacters, .count = 0, .x = -56, .y = 496 },
/* 203 */ { .group = &r16acidants1, .action = spawnCharacters, .count = 0, .x = -72, .y = 480 },
/* 204 */ { .group = &r16acidants2, .action = spawnCharacters, .count = 0, .x = -56, .y = 480 },
/* 205 */ { .group = &r16acidants2, .action = spawnCharacters, .count = 0, .x = -56, .y = 464 },
/* 206 */ { .group = &r16acidants2, .action = spawnCharacters, .count = 0, .x = -56, .y = 448 },
/* 207 */ { .group = &r16acidants2, .action = spawnCharacters, .count = 0, .x = -56, .y = 432 },
/* 208 */ { .group = &r17powerup, .action = spawnCharacters, .count = 0, .x = -40, .y = 424 },
/* 209 */ { .group = &r16acidants2, .action = spawnCharacters, .count = 0, .x = -56, .y = 416 },
/* 210 */ { .group = &r17fly1a, .action = spawnCharacters, .count = 0, .x = -184, .y = 408 },
/* 211 */ { .group = &r17fly1b, .action = spawnCharacters, .count = 0, .x = -104, .y = 408 },
/* 212 */ { .group = &r17fly2a, .action = spawnCharacters, .count = 0, .x = -200, .y = 384 },
/* 213 */ { .group = &r17fly2b, .action = spawnCharacters, .count = 0, .x = -120, .y = 384 },
/* 214 */ { .group = &r17wasp1, .action = spawnCharacters, .count = 0, .x = -104, .y = 344 },
/* 215 */ { .group = &r17wasp3, .action = spawnCharacters, .count = 0, .x = -104, .y = 332 },
/* 216 */ { .group = &r17wasp5, .action = spawnCharacters, .count = 0, .x = -104, .y = 320 },
/* 217 */ { .group = &r17wasp7, .action = spawnCharacters, .count = 0, .x = -104, .y = 308 },
/* 218 */ { .group = &r17wasp9, .action = spawnCharacters, .count = 0, .x = -104, .y = 296 },
/* 219 */ { .group = &waspboss, .action = clearEnemiesAndBullets, .count = 0, .x = -64, .y = 240 },
/* 220 */ { .group = &waspboss, .action = clearObjects, .count = 0, .x = -64, .y = 236 },
/* 221 */ { .group = &waspboss, .action = loadBossPart, .count = 0, .x = -56, .y = 232 },
/* 222 */ { .group = &waspboss, .action = startBackgroundExplosion, .count = 0, .x = -44, .y = 224 },
/* 223 */ { .group = &waspboss, .action = spawnCharacters, .count = 0, .x = -16, .y = 224 },
/* 224 */ { .group = &waspboss, .action = stopStageScroll, .count = 0, .x = -8, .y = 224 }
};
