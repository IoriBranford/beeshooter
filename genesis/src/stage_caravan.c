...
/*  97 */ { .group = &room8alien1, .action = spawnCharacters, .count = 0, .x = -32, .y = 2376 },
/*  98 */ { .group = &room8alien2, .action = spawnCharacters, .count = 0, .x = -56, .y = 2360 },
/*  99 */ { .group = &room8powerup, .action = spawnCharacters, .count = 0, .x = -32, .y = 2272 },
/* 100 */ { .group = &room8alien4, .action = spawnCharacters, .count = 0, .x = -72, .y = 2264 },
/* 101 */ { .group = &room9powerup, .action = spawnCharacters, .count = 0, .x = -16, .y = 2184 },
/* 102 */ { .group = &room9alienmind, .action = spawnCharacters, .count = 0, .x = -16, .y = 2016 },
/* 103 */ { .group = &part2, .action = spawnCharacters, .count = 0, .x = -24, .y = 2008 },
...
/* 118 */ { .group = &r11acidants3b, .action = spawnCharacters, .count = 0, .x = -56, .y = 1624 },
...
/* 121 */ { .group = &r11acidants3e, .action = spawnCharacters, .count = 0, .x = -48, .y = 1600 },
/* 122 */ { .group = &r11acidants3f, .action = spawnCharacters, .count = 0, .x = -56, .y = 1592 },
/* 123 */ { .group = &r11acidants3g, .action = spawnCharacters, .count = 0, .x = -48, .y = 1584 },
/* 124 */ { .group = &room11acidants2b, .action = spawnCharacters, .count = 0, .x = -88, .y = 1584 },
/* 125 */ { .group = &r11acidants3h, .action = spawnCharacters, .count = 0, .x = -56, .y = 1576 },
/* 126 */ { .group = &r11acidants3i, .action = spawnCharacters, .count = 0, .x = -48, .y = 1568 },
/* 127 */ { .group = &r11acidants3j, .action = spawnCharacters, .count = 0, .x = -56, .y = 1560 },
/* 128 */ { .group = &r11acidants3k, .action = spawnCharacters, .count = 0, .x = -48, .y = 1552 },
/* 129 */ { .group = &r12wasp1c, .action = spawnCharacters, .count = 0, .x = -40, .y = 1488 },
/* 130 */ { .group = &r12wasp1b, .action = spawnCharacters, .count = 0, .x = -48, .y = 1472 },
/* 131 */ { .group = &r12wasp1a, .action = spawnCharacters, .count = 0, .x = -56, .y = 1456 },
/* 132 */ { .group = &r12wasp3a, .action = spawnCharacters, .count = 0, .x = -40, .y = 1416 },
/* 133 */ { .group = &r12wasp3b, .action = spawnCharacters, .count = 0, .x = -32, .y = 1408 },
/* 134 */ { .group = &r12wasp3c, .action = spawnCharacters, .count = 0, .x = -24, .y = 1400 },
/* 135 */ { .group = &r12wasp2a, .action = spawnCharacters, .count = 0, .x = -56, .y = 1392 },
/* 136 */ { .group = &r12wasp2b, .action = spawnCharacters, .count = 0, .x = -64, .y = 1384 },
/* 137 */ { .group = &r12wasp2c, .action = spawnCharacters, .count = 0, .x = -72, .y = 1376 },
/* 138 */ { .group = &r12powerup, .action = spawnCharacters, .count = 0, .x = -40, .y = 1368 },
/* 139 */ { .group = &r12wasp4b, .action = spawnCharacters, .count = 0, .x = -16, .y = 1336 },
/* 140 */ { .group = &r12wasp4a, .action = spawnCharacters, .count = 0, .x = -80, .y = 1336 },
/* 141 */ { .group = &r13acidants1, .action = spawnCharacters, .count = 0, .x = -96, .y = 1328 },
/* 142 */ { .group = &r12wasp4d, .action = spawnCharacters, .count = 0, .x = -32, .y = 1312 },
/* 143 */ { .group = &r12wasp4c, .action = spawnCharacters, .count = 0, .x = -64, .y = 1312 },
/* 144 */ { .group = &r13beetle1, .action = spawnCharacters, .count = 0, .x = -48, .y = 1288 },
/* 145 */ { .group = &r13fly1, .action = spawnCharacters, .count = 0, .x = -64, .y = 1192 },
/* 146 */ { .group = &r13fly2, .action = spawnCharacters, .count = 0, .x = -72, .y = 1184 },
/* 147 */ { .group = &r13fly3, .action = spawnCharacters, .count = 0, .x = -48, .y = 1152 },
/* 148 */ { .group = &r14fly4, .action = spawnCharacters, .count = 0, .x = -56, .y = 1144 },
/* 149 */ { .group = &r14acidants1, .action = spawnCharacters, .count = 0, .x = -48, .y = 1128 },
/* 150 */ { .group = &r14beetles, .action = spawnCharacters, .count = 0, .x = -24, .y = 1072 },
/* 151 */ { .group = &r14acidants2, .action = spawnCharacters, .count = 0, .x = -48, .y = 1064 },
/* 152 */ { .group = &r14wasp1a, .action = spawnCharacters, .count = 0, .x = -64, .y = 1064 },
/* 153 */ { .group = &r14wasp1b, .action = spawnCharacters, .count = 0, .x = -72, .y = 1056 },
/* 154 */ { .group = &r14wasp2b, .action = spawnCharacters, .count = 0, .x = -56, .y = 1032 },
/* 155 */ { .group = &r14acidants3, .action = spawnCharacters, .count = 0, .x = -48, .y = 1000 },
/* 156 */ { .group = &r14powerup1, .action = spawnCharacters, .count = 0, .x = -136, .y = 1000 },
/* 157 */ { .group = &r14wasp2a, .action = spawnCharacters, .count = 0, .x = -48, .y = 992 },
/* 158 */ { .group = &r14wasp3a, .action = spawnCharacters, .count = 0, .x = -88, .y = 976 },
/* 159 */ { .group = &r14powerup2, .action = spawnCharacters, .count = 0, .x = -48, .y = 968 },
/* 160 */ { .group = &r14wasp3b, .action = spawnCharacters, .count = 0, .x = -96, .y = 936 },
/* 161 */ { .group = &r14wasp4b, .action = spawnCharacters, .count = 0, .x = -72, .y = 880 },
/* 162 */ { .group = &r15powerup1, .action = spawnCharacters, .count = 0, .x = -48, .y = 872 },
/* 163 */ { .group = &r14wasp4a, .action = spawnCharacters, .count = 0, .x = -88, .y = 872 },
/* 164 */ { .group = &r14wasp4c, .action = spawnCharacters, .count = 0, .x = -104, .y = 864 },
/* 165 */ { .group = &r14wasp5b, .action = spawnCharacters, .count = 0, .x = -104, .y = 816 },
/* 166 */ { .group = &r14wasp5a, .action = spawnCharacters, .count = 0, .x = -88, .y = 808 },
/* 167 */ { .group = &r15powerup2, .action = spawnCharacters, .count = 0, .x = -136, .y = 808 },
/* 168 */ { .group = &r14wasp5c, .action = spawnCharacters, .count = 0, .x = -72, .y = 800 },
/* 169 */ { .group = &r14wasp6a, .action = spawnCharacters, .count = 0, .x = -120, .y = 760 },
/* 170 */ { .group = &Copy_of_r14wasp6a, .action = spawnCharacters, .count = 0, .x = -8, .y = 728 },
/* 171 */ { .group = &r14wasp6b, .action = spawnCharacters, .count = 0, .x = -120, .y = 728 },
/* 172 */ { .group = &Copy_of_r14wasp6b, .action = spawnCharacters, .count = 0, .x = -8, .y = 680 },
/* 173 */ { .group = &r16acidants1, .action = spawnCharacters, .count = 0, .x = -72, .y = 656 },
/* 174 */ { .group = &r16powerup, .action = spawnCharacters, .count = 0, .x = -32, .y = 608 },
/* 175 */ { .group = &r16acidants2, .action = spawnCharacters, .count = 0, .x = -56, .y = 592 },
/* 176 */ { .group = &r16powerup2, .action = spawnCharacters, .count = 0, .x = -16, .y = 520 },
/* 177 */ { .group = &r17powerup, .action = spawnCharacters, .count = 0, .x = -40, .y = 424 },
/* 178 */ { .group = &r17fly1b, .action = spawnCharacters, .count = 0, .x = -104, .y = 408 },
/* 179 */ { .group = &r17fly1a, .action = spawnCharacters, .count = 0, .x = -184, .y = 408 },
/* 180 */ { .group = &r17fly2b, .action = spawnCharacters, .count = 0, .x = -120, .y = 384 },
/* 181 */ { .group = &r17fly2a, .action = spawnCharacters, .count = 0, .x = -200, .y = 384 },
/* 182 */ { .group = &r17wasp1, .action = spawnCharacters, .count = 0, .x = -104, .y = 344 },
/* 183 */ { .group = &r17wasp3, .action = spawnCharacters, .count = 0, .x = -104, .y = 328 },
/* 184 */ { .group = &r17wasp5, .action = spawnCharacters, .count = 0, .x = -104, .y = 312 },
/* 185 */ { .group = &r17wasp7, .action = spawnCharacters, .count = 0, .x = -104, .y = 296 },
/* 186 */ { .group = &r17wasp9, .action = spawnCharacters, .count = 0, .x = -104, .y = 280 },
/* 187 */ { .group = &waspboss, .action = spawnCharacters, .count = 0, .x = -16, .y = 224 },
/* 188 */ { .group = &r18powerup2, .action = spawnCharacters, .count = 0, .x = -152, .y = 208 },
/* 189 */ { .group = &waspboss, .action = stopStageScroll, .count = 0, .x = -32, .y = 144 },
/* 190 */ { .group = &r18powerup3, .action = spawnCharacters, .count = 0, .x = -184, .y = 144 }
};
